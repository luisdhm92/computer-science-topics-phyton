...
from algorithm_design.generic_search import Node, bfs, node_to_path
from data_structures.graph.edge import Edge

V = TypeVar('V') # type of the vertices in the graph_algorithm
...
class Graph(Generic[V]):
    ...
    # Add a vertex to the graph_algorithm and return its index
    def add_vertex(self, vertex: V) -> int:
        self._vertices.append(vertex)
        self._edges.append([]) # add empty list for containing edges
        return self.vertex_count - 1 # return index of added vertex

    # This is an undirected graph_algorithm,
    ...
    # Find the index of a vertex in the graph_algorithm
...
if __name__ == "__main__":
    ...
    # find the shortest path in a undirected graph with bfs
